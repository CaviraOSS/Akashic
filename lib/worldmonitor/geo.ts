...
export const INTEL_HOTSPOTS: Hotspot[] = [
  ...
  },
  {
    id: 'houston',
    name: 'Houston',
    subtext: 'Energy/Aerospace',
    lat: 29.76,
    lon: -95.37,
    location: 'Texas, USA',
    keywords: ['houston', 'spacex', 'oil', 'energy', 'texas', 'exxon', 'chevron', 'lng'],
    agencies: ['Energy Corps', 'Aerospace Industry'],
    description: 'Energy sector HQ. Aerospace industry and launch-economy monitoring.',
    status: 'Monitoring',
  },
  {
    id: 'moscow',
